...
export const LOCATIONS = [
    { id: 7, name: 'Test Room1', address: 'My Room', lat: 12.9213164, lng: 77.5107511, type: 'pickup' },
    { id: 8, name: 'Test Room2', address: 'your Room', lat: 12.9213418, lng: 77.5107577, type: 'drop' },
...
export const RATE_CHART = [
    ...
    { pickupId: 7, dropId: 8, rate: 5 },   // Test Room1 to Test Room2
