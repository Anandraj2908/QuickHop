...
const RiderGenderPreferenceSlider = ({ user, onPreferenceChange }) => {
  const [selectedPreference, setSelectedPreference] = useState(user.riderGenderPreference);
  ...
  return (
    <View style={styles.infoItem}>
      <View>
        <Text style={styles.infoLabel}>Rider Gender Preference</Text>
      </View>
...
export default RiderGenderPreferenceSlider;
